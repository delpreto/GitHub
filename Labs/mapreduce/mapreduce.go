...
type MapReduce struct {
	...
	onlineWorkers    int         // number of available workers
	availableChannel chan string // tracks available workers
	availableBuffer  int         // number of workers in available channel buffer
}
...
func InitMapReduce(nmap int, nreduce int,
	...
	mr.onlineWorkers = 0
	mr.availableBuffer = 100 // Allow 100 servers in buffer for now
	mr.availableChannel = make(chan string, mr.availableBuffer)
